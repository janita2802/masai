...
let findProductDetails = (storeData)  => {
    laptopAvailable = storeData. products.electronicsSection.inventory.laptop.available;
    shirtAvailable = storeData.products.clothingSection.inventory.shirt.available;
    laptopPrice  = storeData.products.electronicsSection.inventory.laptop.price;
    shirtPrice =  storeData.products.clothingSection.inventory.shirt.price;
